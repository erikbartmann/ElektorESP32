#include <WiFi.h>
#define LED1 21 // LED-Pin 1
#define LED2 22 // LED-Pin 2
#define LED3 19 // LED-Pin 3
      ...
      if (client.available()) {           // Sind Daten zum Lesen vorhanden
        ...
        if (c == '\n') {                  // Wenn Byte ist ein Zeilenumbruch...
          if (currentLine.length() == 0) {
            ...
            client.println("<h1>GPIO-Control</h1>");
            client.println("GPIO 21: ");
